...
public extension KeyTypeId {
    /// Key type for Babe module, built-in.
    static let babe = KeyTypeId(rawValue: "babe")!
    /// Key type for Grandpa module, built-in.
    static let grandpa = KeyTypeId(rawValue: "gran")!
    /// Key type for controlling an account in a Substrate runtime, built-in.
    static let account = KeyTypeId(rawValue: "acco")!
    /// Key type for Aura module, built-in.
    static let aura = KeyTypeId(rawValue: "aura")!
    /// Key type for ImOnline module, built-in.
    static let imOnline = KeyTypeId(rawValue: "imon")!
    /// Key type for AuthorityDiscovery module, built-in.
    static let authorityDiscovery = KeyTypeId(rawValue: "audi")!
    /// A key type ID useful for tests.
    static let dummy = KeyTypeId(rawValue: "dumy")!
}
