...
public extension Value {
    static func calculateSize(
        in decoder: ScaleCodec.Decoder, for id: RuntimeTypeId, runtime: any Runtime
    ) throws -> Int {
...
private extension Value {
    ...
    static func _tupleSize<D: SkippableDecoder>(
        from decoder: inout D, fields: [RuntimeTypeId], runtime: any Runtime
    ) throws -> Int {
    ...
    static func _arraySize<D: SkippableDecoder>(
        from decoder: inout D, count: Int, type: RuntimeTypeId, runtime: any Runtime
    ) throws -> Int {
    ...
    static func _sequenceSize<D: SkippableDecoder>(
        from decoder: inout D, type: RuntimeTypeId, runtime: any Runtime
    ) throws -> Int {
    ...
    static func _compositeSize<D: SkippableDecoder>(
        from decoder: inout D, fields: [RuntimeTypeField], runtime: any Runtime
    ) throws -> Int {
        try fields.reduce(0) { sum, field in
    ...
    static func _variantSize<D: SkippableDecoder>(
        from decoder: inout D, type: RuntimeTypeId, variants: [RuntimeTypeVariantItem], runtime: any Runtime
    ) throws -> Int {
